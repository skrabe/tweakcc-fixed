...
[![Claude Code](https://img.shields.io/badge/Claude%20Code-2.0.98%20%E2%86%92%202.1.282-d97757?style=flat-square)](https://github.com/anthropics/claude-code)
...
| ---------------------------- | :-----------: | :-------: |
| Prompt sites (CC 2.1.282)    |   **9,376**   |    777    |
| Unique prompt IDs            |   **8,913**   |    777    |
| Patches                      |    **64**     |    49     |
...
- `complexity-router` **`[opt-in]`** — opt-in Opus 5.5 / Fable 5.1 model entries that route reasoning effort by task difficulty _(experimental)_
